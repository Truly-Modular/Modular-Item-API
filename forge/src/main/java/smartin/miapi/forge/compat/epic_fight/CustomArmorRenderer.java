...
public class CustomArmorRenderer extends ModelRenderLayer<
    ...
    @Override
    protected void renderLayer(AbstractClientPlayerPatch<AbstractClientPlayerEntity> abstractClientPlayerEntityAbstractClientPlayerPatch, AbstractClientPlayerEntity abstractClientPlayerEntity, @Nullable ModularItemFeatureLayer modularItemFeatureLayer, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i, OpenMatrix4f[] openMatrix4fs, float v, float v1, float v2, float v3) {
