...
@Mixin(value = smartin.miapi.item.modular.items.ExampleModularStrackableItem.class)
public abstract class ExampleModularItemStackAbleMixin implements ModularItemInject {
