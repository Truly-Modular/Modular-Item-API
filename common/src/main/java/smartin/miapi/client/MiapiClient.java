...
public class MiapiClient {
    ...
    public static final KeyBinding MATERIAL_DEBUG_KEY = KEY_BINDINGS.register("debug_key", new KeyBinding("miapi.ui.materia.debug", GLFW.GLFW_KEY_LEFT_CONTROL, "miapi"));
