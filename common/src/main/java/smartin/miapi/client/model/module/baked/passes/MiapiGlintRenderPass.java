...
public class MiapiGlintRenderPass implements RenderPass {
    DoubleQuadCache[] quadCaches;
    GlintProperty.GlintSettings settings;
    float alphaAdjust;

    public MiapiGlintRenderPass(ModuleInstance moduleInstance, ItemStack stack, GlintProperty.GlintSettings settings, ItemDisplayContext context, ModelHolder modelHolder, BakedModelCache cache, RandomSource random) {
