...
public class StiffVerletIntegrator {
    ...
    private static void integrateMotion(
        ...
        for (ChainNode n : s.nodes) {
            ...
            // standard Verlet velocity term (no dt scaling hacks)
    ...
    private static void solveConstraints(
        ...
        for (ChainSegment seg : s.segments) {
            ...
            Vector3f correctionA = new Vector3f(delta).mul(wA / wSum);
            Vector3f correctionB = new Vector3f(delta).mul(wB / wSum);
