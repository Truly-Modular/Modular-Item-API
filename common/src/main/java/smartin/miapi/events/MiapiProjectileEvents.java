...
public final class MiapiProjectileEvents {
    ...
    public static Event<ItemProjectileCompound> MODULAR_PROJECTILE_NBT_WRITE = EventFactory.createEventResult();
    public static Event<ItemProjectileCompound> MODULAR_PROJECTILE_NBT_READ = EventFactory.createEventResult();
    public static Event<ItemProjectileDataTracker> MODULAR_PROJECTILE_DATA_TRACKER_INIT = EventFactory.createEventResult();
    public static Event<ItemProjectileDataTracker> MODULAR_PROJECTILE_DATA_TRACKER_SET = EventFactory.createEventResult();
