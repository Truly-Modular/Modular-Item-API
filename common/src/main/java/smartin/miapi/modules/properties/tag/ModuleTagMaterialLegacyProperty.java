...
public class ModuleTagMaterialLegacyProperty extends CodecProperty<List<String>> {
    public static final ResourceLocation KEY = Miapi.id("material_property");
    public static ModuleTagMaterialLegacyProperty property;
    public static Codec<List<String>> CODEC = Codec.list(Codec.STRING);

    public ModuleTagMaterialLegacyProperty() {
        super(CODEC);
        property = this;
    }
