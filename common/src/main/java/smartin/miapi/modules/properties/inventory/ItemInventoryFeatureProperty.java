...
public class ItemInventoryFeatureProperty extends CodecProperty<Map<ResourceLocation, InventoryFeatureType.FeatureSet>> {
    public static ResourceLocation KEY = Miapi.id("item_inventory_features");
    public static ItemInventoryFeatureProperty property = new ItemInventoryFeatureProperty();

    protected ItemInventoryFeatureProperty() {
