...
public class TagWhiteListFeatureType implements InventoryFeatureType<List<TagKey<Item>>> {

    public static final TagWhiteListFeatureType FEATURE = new TagWhiteListFeatureType();

    private TagWhiteListFeatureType() {

    }

    public static final ResourceLocation ID =
            Miapi.id("contents_whitelist");
