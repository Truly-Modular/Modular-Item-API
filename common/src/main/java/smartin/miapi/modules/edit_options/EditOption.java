 ...
 * EditOptions need to be registered at {@link smartin.miapi.Miapi#editOptions}
 */
public interface EditOption {

    /**
     * This is the Logic that actually executes the Edit.
     * The Buffer is the on parsed into by the consumers of the {@link EditOption#getGui(Consumer, Consumer, Consumer)}
     *
