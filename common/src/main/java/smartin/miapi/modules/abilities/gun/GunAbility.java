...
public class GunAbility implements ItemUseAbility<GunAbility.GunAbilityContext> {

    @Override
    public boolean allowedOnItem(ItemStack itemStack, Level world, Player player, InteractionHand hand, ItemAbilityManager.AbilityHitContext abilityHitContext, GunAbilityContext context) {
        return true;
    }

    @Override
    public UseAnim getUseAction(ItemStack itemStack, GunAbilityContext context) {
        return UseAnim.NONE;
    }

    @Override
    public int getMaxUseTime(ItemStack itemStack, LivingEntity livingEntity, GunAbilityContext context) {
    ...
    @Override
    public InteractionResultHolder<ItemStack> use(Level world, Player user, InteractionHand hand, GunAbilityContext context) {
    ...
    @Override
    public void usageTick(Level world, LivingEntity user, ItemStack stack, int remainingUseTicks, GunAbilityContext context) {
